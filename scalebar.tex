...
%- compile the file
%- Figure 1 of the document should show the exact same scale-bar you've drawn in MATLAB overlayed over the image and a second scale bar which shows a reasonable length (5cm in our case)
...
%- enjoy typographically correct scale bars in the resulting pdf (47 kB)
